...
namespace Maldivas.Entities.Main.Model
{
    public partial class Transportistas
    {
        ...
        {
            Transportistas_departamentos = new HashSet<Transportistas_departamentos>();
            Transportistas_matriculas = new HashSet<Transportistas_matriculas>();
            Transportistas_visitas = new HashSet<Transportistas_visitas>();
        }
        ...
        public virtual ICollection<Transportistas_departamentos> Transportistas_departamentos { get; set; }
        public virtual ICollection<Transportistas_matriculas> Transportistas_matriculas { get; set; }
        public virtual ICollection<Transportistas_visitas> Transportistas_visitas { get; set; }
    }
}
